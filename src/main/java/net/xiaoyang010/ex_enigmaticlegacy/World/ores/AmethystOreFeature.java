...
public class AmethystOreFeature extends OreFeature {
    public static AmethystOreFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("ex_enigmaticlegacy:amethyst_ore", FEATURE, new OreConfiguration(AmethystOreFeatureRuleTest.INSTANCE, ((Block) ModBlockss.AMETHYST_ORE.get()).defaultBlockState(), 6));
    ...
    private static class AmethystOreFeatureRuleTest extends RuleTest {
        ...
        private static final Codec<AmethystOreFeatureRuleTest> CODEC = Codec.unit(() -> {
            return INSTANCE;
        });
        private static final RuleTestType<AmethystOreFeatureRuleTest> CUSTOM_MATCH = () -> {
            return CODEC;
        };
        ...
        public static void init(FMLCommonSetupEvent event) {
            Registry.register(Registry.RULE_TEST, new ResourceLocation("ex_enigmaticlegacy:amethyst_ore_match"), CUSTOM_MATCH);
        }
