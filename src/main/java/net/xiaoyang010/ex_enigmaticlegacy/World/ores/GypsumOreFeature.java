...
public class GypsumOreFeature extends OreFeature {
    public static GypsumOreFeature FEATURE = null;
    ...
    private static class GypsumOreFeatureRuleTest extends RuleTest {
        static final GypsumOreFeatureRuleTest INSTANCE = new GypsumOreFeatureRuleTest();
        private static final Codec<GypsumOreFeatureRuleTest> CODEC = Codec.unit(() -> {
            return INSTANCE;
        });
        private static final RuleTestType<GypsumOreFeatureRuleTest> CUSTOM_MATCH = () -> {
            return CODEC;
        };
        private List<Block> base_blocks = null;

        private GypsumOreFeatureRuleTest() {
        }

        @SubscribeEvent
        public static void init(FMLCommonSetupEvent event) {
            Registry.register(Registry.RULE_TEST, new ResourceLocation("ex_enigmaticlegacy:gypsum_ore_match"), CUSTOM_MATCH);
        }
