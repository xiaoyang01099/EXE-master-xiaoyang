...
public class LeadOreFeature extends OreFeature {
    ...
    public static Feature<?> feature() {
        ...
        CONFIGURED_FEATURE = FeatureUtils.register("ex_enigmaticlegacy:lead_ore", FEATURE, new OreConfiguration(LeadOreFeatureRuleTest.INSTANCE, ((Block) ModBlockss.LEAD_ORE.get()).defaultBlockState(), 6));
        PLACED_FEATURE = PlacementUtils.register("ex_enigmaticlegacy:lead_ore", CONFIGURED_FEATURE, List.of(CountPlacement.of(2), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(-30), VerticalAnchor.absolute(60)), BiomeFilter.biome()));
        return FEATURE;
    }
    ...
    private static class LeadOreFeatureRuleTest extends RuleTest {
        ...
        private static final Codec<LeadOreFeatureRuleTest> CODEC = Codec.unit(() -> {
            return INSTANCE;
        });
        private static final RuleTestType<LeadOreFeatureRuleTest> CUSTOM_MATCH = () -> {
            return CODEC;
        };
        private List<Block> base_blocks = null;

        private LeadOreFeatureRuleTest() {
        }

        @SubscribeEvent
        public static void init(FMLCommonSetupEvent event) {
            Registry.register(Registry.RULE_TEST, new ResourceLocation("ex_enigmaticlegacy:lead_ore_match"), CUSTOM_MATCH);
        }
