...
public class BronzeOreFeature extends OreFeature {
    ...
    private static class BronzeOreFeatureRuleTest extends RuleTest {
        static final BronzeOreFeatureRuleTest INSTANCE = new BronzeOreFeatureRuleTest();
        private static final Codec<BronzeOreFeatureRuleTest> CODEC = Codec.unit(() -> {
            return INSTANCE;
        });
        private static final RuleTestType<BronzeOreFeatureRuleTest> CUSTOM_MATCH = () -> {
            return CODEC;
        };
        private List<Block> base_blocks = null;

        private BronzeOreFeatureRuleTest() {
        }

        @SubscribeEvent
        public static void init(FMLCommonSetupEvent event) {
            Registry.register(Registry.RULE_TEST, new ResourceLocation("ex_enigmaticlegacy:bronze_ore_match"), CUSTOM_MATCH);
        }
