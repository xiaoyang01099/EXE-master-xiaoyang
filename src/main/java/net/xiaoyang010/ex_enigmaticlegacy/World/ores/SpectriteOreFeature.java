...
public class SpectriteOreFeature extends OreFeature {
    public static SpectriteOreFeature FEATURE = null;
    ...
    private static class SpectriteOreFeatureRuleTest extends RuleTest {
        static final SpectriteOreFeatureRuleTest INSTANCE = new SpectriteOreFeatureRuleTest();
        private static final Codec<SpectriteOreFeatureRuleTest> CODEC = Codec.unit(() -> {
            return INSTANCE;
        });
        private static final RuleTestType<SpectriteOreFeatureRuleTest> CUSTOM_MATCH = () -> {
            return CODEC;
        };
        private List<Block> base_blocks = null;

        private SpectriteOreFeatureRuleTest() {
        }

        @SubscribeEvent
        public static void init(FMLCommonSetupEvent event) {
            Registry.register(Registry.RULE_TEST, new ResourceLocation("ex_enigmaticlegacy:spectrite_ore_match"), CUSTOM_MATCH);
        }
