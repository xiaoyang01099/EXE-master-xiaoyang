...
public class InfinityArmorModel extends HumanoidModel {
    String s = "ex_enigmaticlegacy:textures/models/";
    ...
    private void renderBaseInfinityTexture(PoseStack mStack, int i1, int i2, float i3, float i4, float i5, float i6) {
        ResourceLocation baseTexture = new ResourceLocation("ex_enigmaticlegacy", "textures/models/armor/infinity_armor.png");

        VertexConsumer baseBuffer = this.buf.getBuffer(RenderType.armorCutoutNoCull(baseTexture));
        super.renderToBuffer(mStack, baseBuffer, i1, i2, i3, i4, i5, i6);
    }
    ...
    public void renderToBuffer(PoseStack mStack, VertexConsumer vertexBuilder, int i1, int i2, float i3, float i4, float i5, float i6) {
        ...
        renderBaseInfinityTexture(mStack, i1, i2, i3, i4, i5, i6);
...
//            mStack.scale(scale, scale, scale);
    ...
    public void update(LivingEntity e, ItemStack i, EquipmentSlot a) {
        ...
        boolean hasHat = hats.getItem() == AvaritiaModContent.INFINITY_HELMET.get();
        boolean hasChest = chest.getItem() == AvaritiaModContent.INFINITY_CHESTPLATE.get();
        boolean hasLeg = leg.getItem() == AvaritiaModContent.INFINITY_LEGS.get();
        boolean hasFoot = foot.getItem() == AvaritiaModContent.INFINITY_BOOTS.get();
