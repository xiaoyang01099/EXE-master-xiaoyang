...
public class ArdentAzarcissus extends FlowerBlock {
    public ArdentAzarcissus() {
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ModBlockss.ARDENT_AZARCISSUS.get(), renderType -> renderType == RenderType.cutout());
    }
