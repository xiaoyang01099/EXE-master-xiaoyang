...
public class NebulaRing extends ItemBauble implements ICurioItem {
    private static final String TAG_MANA = "mana";
    private static final int MAX_MANA = 48000000;
    private static final int MAX_DAMAGE = 1000;

    public NebulaRing(Properties properties) {
        super(properties
