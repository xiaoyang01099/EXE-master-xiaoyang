...
public class StreetLightFlowerBlock extends FlowerBlock {
    public StreetLightFlowerBlock() {
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ModBlockss.STREET_LIGHT.get(), renderType -> renderType == RenderType.cutout());
    }
