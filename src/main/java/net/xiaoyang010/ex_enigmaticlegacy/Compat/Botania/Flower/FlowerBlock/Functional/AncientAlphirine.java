...
public class AncientAlphirine extends FlowerBlock {
    public AncientAlphirine() {
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ModBlockss.ANCIENT_ALPHIRINE.get(), renderType -> renderType == RenderType.cutout());
    }
