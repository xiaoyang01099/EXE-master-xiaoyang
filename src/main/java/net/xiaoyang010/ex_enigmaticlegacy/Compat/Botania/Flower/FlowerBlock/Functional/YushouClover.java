...
public class YushouClover extends FlowerBlock {
    public YushouClover() {
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ModBlockss.YU_SHOU_CLOVER.get(), renderType -> renderType == RenderType.cutout());
    }
