...
public class BlazingOrchidFlowerBlock extends FlowerBlock {
    public BlazingOrchidFlowerBlock() {
        super(MobEffects.MOVEMENT_SPEED,100, Properties.of(Material.PLANT)
                .noCollission()
                .instabreak()
                .sound(SoundType.GRASS)
                .lightLevel(state -> 8)
                .explosionResistance(1200000.0F));
    }
    @Override
    ...
    public static void registerRenderLayer() {
        ItemBlockRenderTypes.setRenderLayer(ModBlockss.BLAZING_ORCHID.get(), renderType -> renderType == RenderType.cutout());
    }
