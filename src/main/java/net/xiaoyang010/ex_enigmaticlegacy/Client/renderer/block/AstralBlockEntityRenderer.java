...
public class AstralBlockEntityRenderer implements BlockEntityRenderer<AstralBlockEntity> {
    ...
    public void render(@NotNull AstralBlockEntity astralBlockEntity, float partialTicks, @NotNull PoseStack poseStack, @NotNull MultiBufferSource source, int packedLight, int packedOverlay) {
    ...
    public boolean shouldRenderOffScreen(@NotNull AstralBlockEntity astralBlockEntity) {
        return true;
    }
}
