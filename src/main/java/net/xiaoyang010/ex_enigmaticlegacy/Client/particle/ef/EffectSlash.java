...
public class EffectSlash extends Effect {
    ...
    public float slashWidth = 0.0f;
    public float slashRange = 0.0f;
    public float slashRadius = 0.0f;
    ...
    public void read(CompoundTag tag) {
        ...
        this.slashRadius = tag.getFloat("slashRadius");
        this.slashWidth = tag.getFloat("slashWidth");
        this.slashRange = tag.getFloat("slashRange");
    }
    ...
    public CompoundTag write() {
        ...
        tag.putFloat("slashRadius", this.slashRadius);
        tag.putFloat("slashWidth", this.slashWidth);
        tag.putFloat("slashRange", this.slashRange);
        return tag;
    }
    ...
    public void render(PoseStack poseStack, float pticks) {
        ...
        RenderSystem.setShaderTexture(0, RenderUtil.glow_texture);
        ...
        RenderUtil.renderSlash(buffer, matrix, 0.0, 0.0, 0.0,
                this.r, this.g, this.b, alpha,
                this.slashRadius, this.slashWidth, this.slashRange);
